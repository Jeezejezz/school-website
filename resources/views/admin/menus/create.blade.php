                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('route_name') is-invalid @enderror" 
                                            ...
                                            <option value="about" {{ old('route_name') == 'about' ? 'selected' : '' }}>about</option>
                                            <option value="academics" {{ old('route_name') == 'academics' ? 'selected' : '' }}>academics</option>
                                            <option value="gallery" {{ old('route_name') == 'gallery' ? 'selected' : '' }}>gallery</option>
                                            <option value="news" {{ old('route_name') == 'news' ? 'selected' : '' }}>news</option>
